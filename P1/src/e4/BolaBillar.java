...
public enum BolaBillar {
    ...
    //Creamos el enumerado con los números
    BLANCO(0, "BLANCO", "LISA"),
    ...
    //Creamos unas constantes que caractericen nuestro objecto
    final int numero;
    final String color;
    final String tipo;

    //Creamos una función constructora del objecto
